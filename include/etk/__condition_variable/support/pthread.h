#ifndef _ETK___CONDITION_VARIABLE_SUPPORT_PTHREAD_H_
#define _ETK___CONDITION_VARIABLE_SUPPORT_PTHREAD_H_
...
#endif // _ETK___CONDITION_VARIABLE_SUPPORT_PTHREAD_H_