...
inline _ETK_API_INTERNAL int __etk_semaphore_init(__etk_semaphore_t *__s,
...
inline _ETK_API_INTERNAL int __etk_semaphore_getvalue(__etk_semaphore_t *__s,
                                                      int *__value) {
    return tx_semaphore_info_get(__s, NULL, (ULONG *)&__value, NULL, NULL,
                                 NULL);
}
